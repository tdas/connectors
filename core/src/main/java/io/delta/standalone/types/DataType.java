...
public abstract class DataType implements Serializable {
    ...
    public static DataType fromJson(String json) {
        throw new RuntimeException("use DataTypeUtils.fromJson instead");
    }
     ...
     */
    public String toJson() { throw new RuntimeException("use DataTypeUtils.toJson instead"); }

    /**
     * @return a pretty (i.e. indented) JSON {@code String} representation of the type
     */
    public String toPrettyJson() { throw new RuntimeException("use DataTypeUtils.toJson instead");  }
