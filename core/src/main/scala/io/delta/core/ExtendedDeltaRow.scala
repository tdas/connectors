...
import io.delta.core.data.DeltaRow
 ...
 */
case class ExtendedDeltaRow(
  innerRow: DeltaRow,
  schema: StructType,
  partitionValues: Map[String, Any]) extends DeltaRow {
  ...
  override def getRecord(fieldName: String): DeltaRow =
    getAs[DeltaRow](fieldName)(innerRow.getRecord)
